...
console.log(JsUser[mySym]);//myKey1 and in sqaure bracket its as symbol or else it will be considered a string
...
JsUser2.greetings=function(){
    console.log(`Hello, welcome back !!,${this.name}`);// includes the name from the object JsUser2   as--Hello , welcome back !!Ayush Dubey 
}
...
/*This is the concept of array of object values */
...
const users=[
    {
        id:"1",name:"Akd",email:"akd@gmail.com"
    },
    {
        id:"2",name:"skd",email:"skd@gmail.com"
    },
    {
        id:"3",name:"hkd",email:"hkd@gmail.com"
    },
    {
        id:"4",name:"sskd",email:"sskd@gmail.com"
    },
]
...
//An json formatter needed to decode the json codes.
//we can also develop our own json formatter 



//-----------ode 02_basics/Objects-16-18.js-----------//
